...
@section('content')
    <div class="min-w-screen min-h-screen flex items-center p-5 lg:p-10  overflow-hidden relative">
        <div class="flex-1 min-h-full min-w-full rounded-3xl
         p-5 lg:p-10 text-gray-800 md:flex items-center text-center md:text-left" style="opacity: 100% !important;">
            <div class="w-full md:w-1/2">
                <div class="mb-10 lg:mb-20">
                </div>
                <div class="mb-10 md:mb-20 text-gray-600 text-right ">
                    <h1 class="font-black uppercase text-3xl lg:text-5xl text-yellow-500 mb-10">فکنم گم شدی!</h1>
                    <p class="dark:text-gray-200 text-gray-600">صفحه مورد نظر شما یافت نشد.</p>
                    <p class="dark:text-gray-200 text-gray-600 mt-2">برای بازگشت به صفحه اصلی سایت روی این <a
                            href="/" class="text-blue-400 hover:text-blue-600">لینک</a> کلیک کنید </p>
                </div>
