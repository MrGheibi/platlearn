...
@section('content')
    {{--<header>
        <div class="flex flex-wrap">
            <div class="w-1/2 bg-cover bg-center">
                <div class="mt-20">
                    <img src="/assets/Images/coder.svg" class="w-3/6 md:w-32 lg:w-48" alt="">
                </div>
            </div>
            <div class="w-1/2 bg-cover bg-center">
    ...
    <div>
        ...
        <div class="container mx-auto flex">
            <div class="flex py-12 px-4">
                <div class="flex justify-center lg:mr-5 items-center lg:items-start flex-col text-white flex-1">
                    <a href="/skills-chart"
                       class="transition duration-150 ease-in-out mb-4 rounded-full bg-gray-700 py-2 px-4 flex items-center hover:bg-blue-500 hover:text-gray-200">شروع
                    ...
                    <h1 class="text-4xl xl:text-4xl font-bold text-blue-500
                     text-center mb-3 text-shadow leading-relaxed">پلت لرن <span
                            class="dark:text-gray-100 text-gray-700 xl:text-3xl">، پلت فرمی متفاوت برای یادگیری</span>
                    </h1>
                    <p class="leading-8 text-md text-shadow dark:text-gray-100 mt-4 text-gray-700 text-center lg:text-right">
                        ما باور داریم که کاربران ایرانی
                        لایق بهترین‌ها هستند، از این رو ما تمام تلاش خود را می‌کنیم تا بتوانیم فیلم‌ها و مقالات آموزشی
                        بروز و کاربردی را در اختیارتان قرار دهیم تا با استفاده از آنها بتوانید جزء بهترین‌ها در صنعت
                        طراحی و برنامه‌نویسی وب شوید. ما ادعا نمی‌کنیم که بهترین هستیم ولی همیشه تمام تلاش خود را
                        می‌کنیم بهترین عملکرد را به شما ارائه دهیم.</p>
                </div>
                <div class="justify-end ml-5 flex-1 hidden lg:flex">
                    <div class="flex  w-8/12">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 722.67 721.42">
                            <defs>
                                <style>
                                    .cls-1 {
                                        fill: #d39676;
                                    ...
                                    .cls-17, .cls-23, .cls-27, .cls-5, .cls-6 {
                                        fill: #fff;
                                    }
                            ...
                            <g id="Work">
                                ...
                                <path class="cls-7"
                                      ...
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-6"
                                      d="M690.75,460.12s2.47,0,2.87.94a13.15,13.15,0,0,1-4.3,2.83l-2.73-1.29Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-7"
                                ...
                                <path class="cls-7"
                                      ...
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-6"
                                      d="M699.1,476a5.36,5.36,0,0,1-1.69,3.22s-4.31-.68-5.32-1a8.14,8.14,0,0,1,1.37-3.39Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-2"
                                ...
                                <polygon class="cls-10"
                                         points="554.89 539.57 541.03 553.44 541.27 525.03 554.89 525.03 554.89 539.57"/>
                                <rect class="cls-5" x="535.74" y="626.31" width="24.68" height="4.95"/>
                                <circle class="cls-8" cx="635.35" cy="696.85" r="11.93"/>
                                <path class="cls-11"
                                      d="M1037.93,834.81a8.29,8.29,0,1,1-8.29-8.29A8.29,8.29,0,0,1,1037.93,834.81Z"
                                      transform="translate(-394.29 -137.96)"/>
                                ...
                                <polygon class="cls-8"
                                         points="644.01 684.45 637.46 699.89 632.47 699.89 632.47 681.51 644.01 684.45"/>
                                <polygon class="cls-5"
                                         points="644.01 675.29 638.95 675.5 551.49 646.22 560.42 646.22 644.01 675.29"/>
                                <circle class="cls-8" cx="460.81" cy="696.85" r="11.93"/>
                                <circle class="cls-11" cx="855.1" cy="834.81" r="8.29"
                                        transform="translate(-734.13 711.2) rotate(-45)"/>
                                ...
                                <polygon class="cls-8"
                                         points="452.16 684.45 458.71 699.89 463.7 699.89 463.7 681.51 452.16 684.45"/>
                                <polygon class="cls-5"
                                         points="452.16 675.29 453.85 675.5 544.68 646.22 535.74 646.22 452.16 675.29"/>
                                ...
                                <polygon class="cls-20"
                                         points="526.14 93.68 486.82 87.52 486.82 92.65 525.99 94.92 526.14 93.68"/>
                                <polygon class="cls-5"
                                         points="490.68 88.12 492.05 90.35 508.58 92.23 507.9 90.82 490.68 88.12"/>
                                <path class="cls-11"
                                ...
                                <polygon class="cls-2"
                                         points="495.74 105.83 490.98 112.89 477.24 120.27 492.65 117.03 495.74 105.83"/>
                                <path class="cls-21"
                                ...
                                <path class="cls-12"
                                      ...
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M698.38,633.08a1.79,1.79,0,1,1-1.79-1.79A1.79,1.79,0,0,1,698.38,633.08Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M691.92,633.08a1.79,1.79,0,1,1-1.79-1.79A1.79,1.79,0,0,1,691.92,633.08Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M686.48,631.29a1.79,1.79,0,1,1-1.79-1.79A1.79,1.79,0,0,1,686.48,631.29Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M681.05,627.7a1.8,1.8,0,1,1-1.8-1.79A1.81,1.81,0,0,1,681.05,627.7Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M676.53,623.74a1.79,1.79,0,1,1-1.79-1.8A1.79,1.79,0,0,1,676.53,623.74Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-24"
                                ...
                                <path class="cls-12"
                                      ...
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M780.73,809.52a1.85,1.85,0,1,1-1.85-1.85A1.85,1.85,0,0,1,780.73,809.52Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M779.73,815.73a1.85,1.85,0,1,1-1.85-1.85A1.85,1.85,0,0,1,779.73,815.73Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M776.76,821.31a1.85,1.85,0,1,1-1.84-1.85A1.84,1.84,0,0,1,776.76,821.31Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M771.13,825a1.85,1.85,0,1,1-1.85-1.85A1.85,1.85,0,0,1,771.13,825Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M763.86,827.44a1.85,1.85,0,1,1-1.85-1.85A1.84,1.84,0,0,1,763.86,827.44Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-24"
                                ...
                                <path class="cls-5"
                                      d="M636.13,186.67v-6.12a8.44,8.44,0,0,0-8.44-8.45H469.3a8.44,8.44,0,0,0-8.44,8.45v6.12Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-5"
                                      d="M460.86,330.45v53.6a8.45,8.45,0,0,0,8.44,8.45H627.69a8.45,8.45,0,0,0,8.44-8.45v-53.6Z"
                                      transform="translate(-394.29 -137.96)"/>
                                ...
                                <g class="cls-26">
                                    <path
                                        d="M561.14,278.59V260.07c-33,69.17-33,140.61,0,209.78h8C539.11,406.84,536.45,341.94,561.14,278.59Z"
                                        transform="translate(-394.29 -137.96)"/>
                                ...
                                <path class="cls-5"
                                      d="M556.38,152.73a5.69,5.69,0,1,1-5.67-6.13A5.92,5.92,0,0,1,556.38,152.73Z"
                                      transform="translate(-394.29 -137.96)"/>
                                <path class="cls-11"
                                ...
                                <polygon class="cls-6"
                                         points="389.21 328.23 331.32 328.23 317.84 344.08 385.73 344.08 389.21 328.23"/>
                                <polygon class="cls-8"
                                         points="468.31 333.55 461.66 333.02 461.02 334.25 468.71 334.89 468.31 333.55"/>
                                <polygon class="cls-8"
                                         points="459.62 332.82 452.97 332.29 452.33 333.52 460.02 334.17 459.62 332.82"/>
                                <polygon class="cls-8"
                                         points="450.94 332.1 444.28 331.56 443.64 332.79 451.33 333.44 450.94 332.1"/>
                                <polygon class="cls-8"
                                         points="442.25 331.37 435.59 330.83 434.96 332.07 442.65 332.71 442.25 331.37"/>
                                <polygon class="cls-8"
                                         points="433.56 330.64 426.9 330.11 426.27 331.34 433.96 331.98 433.56 330.64"/>
                                <polygon class="cls-8"
                                         points="424.87 329.91 418.22 329.38 417.58 330.61 425.27 331.25 424.87 329.91"/>
                                <polygon class="cls-8"
                                         points="416.18 329.18 409.53 328.65 408.89 329.88 416.58 330.53 416.18 329.18"/>
                                <polygon class="cls-8"
                                         points="407.5 328.45 400.84 327.92 400.2 329.15 407.89 329.8 407.5 328.45"/>
                                <polygon class="cls-8"
                                         points="398.81 327.73 392.15 327.19 391.52 328.43 399.21 329.07 398.81 327.73"/>
                                ...
                                <polygon class="cls-16"
                                         points="13.77 437.73 13.77 721.42 29.88 721.42 37.14 436.51 13.77 437.73"/>
                                <polygon class="cls-16"
                                         points="219.21 437.73 219.21 721.42 235.31 721.42 242.57 436.51 219.21 437.73"/>
                                <polygon class="cls-16"
                                         points="504.57 437.7 504.57 714.62 519.78 714.62 526.64 436.51 504.57 437.7"/>
                            </g>
                        </svg>
                    </div>
                </div>
    ...
    <div class="container mx-auto px-4 mt-16">
        ...
        <div class="mt-20">
            <h2 class="text-xl transition duration-300 ease-in-out text-gray-800 text-center text-bold font-bold dark:text-white md:text-2xl mb-5 mr-4">
                دسته بندی ها
            </h2>
            <section class="p-10 flex md:flex-row items-center justify-around flex-wrap sm:flex-col">

                <!-- scale -->
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    <div
                        class="absolute inset-0 dark:bg-white dark:opacity-25 bg-gray-400 opacity-25 rounded-lg shadow-2xl"></div>
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 rounded-lg" src="/assets/Icons/Laravel.png" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    ...
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 rounded-lg" src="/assets/Icons/javascript.svg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    ...
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 rounded-lg" src="/assets/Icons/vuejs.svg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    ...
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 pt-9 rounded-lg" src="/assets/Icons/tailwind.svg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    ...
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 rounded-lg" src="/assets/Icons/python.svg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="h-32 w-32 relative cursor-pointer mb-5">
                    ...
                    <div class="absolute inset-0 transform  hover:scale-75 transition duration-300">
                        <div class="h-full w-full dark:bg-gray-800 bg-white rounded-lg shadow-xl">
                            <img width="130" class="p-5 rounded-lg" src="/assets/Icons/php.svg" alt="">
                        </div>
                    </div>
                </div>
    ...
    <div class="container  mx-auto  transition duration-300 ease-in-out px-4 mt-16">
        <div class="popular-movies">
            <h2 class="text-xl mb-5 transition duration-300 ease-in-out text-gray-700 dark:text-white font-bold md:text-2xl mb-5 mr-4">
                جدیدترین ها 🔥
            </h2>
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 grid-flow-row gap-4">
                <div>
                    <div class="m-auto  duration-300 ease-in py-2 max-w-xl ">
                        <div class="dark:bg-gray-800  bg-white shadow-lg rounded-2xl">
                            <div class="mx-2 pt-2 relative">
                                ...
                                <span class="absolute mt-4 top-0 right-0 p-1 bg-gray-700 mt-3 mr-2 text-xs rounded  text-white animate-pulse bg-opacity-50">در حال ضبط 🎥</span>
                            ...
                            hover:text-blue-500 dark:hover:text-blue-400">آموزش
                                    لاراول</h2>
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-300 my-3 dark:opacity-60 opacity-85 ">
                                    در دوره آموزش php ما سعی می‌کنیم php را به شکل جامع و کاملا رایگان به شما آموزش دهیم.
                                </p>

                                <div class="text-gray-200 mt-5 border-b-2 pb-4 border-gray-300 dark:border-gray-600">
    ...
    <div class="container  px-4 pt-16">
        <div class="w-full  bg-gray-500 rounded-xl banner-img  bg-no-repeat" style="">
            <div class=" p-10  py-20  flex text-4xl flex-col  flex-wrap  justify-center  content-center">
                <div class="text-white text-xl lg:text-2xl text-center">کنال یوتیوب ما را از دست ندهید !</div>
                <div class="text-xl  text-white  mt-5 text-center">مخزن آموزش های رایگان</div>
            </div>
        </div>
    </div>
    <div class="containermt-16">
        <div class=" py-8">
            <div class="container mx-auto">
                <div class="flex items-center justify-between">
                    <h2 class="text-xl transition duration-300 ease-in-out font-bold m-auto text-center text-gray-700 dark:text-white md:text-2xl mb-5 mr-3">
                        آخرین مقالات 🔥
                    </h2>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 grid-flow-row gap-4">
                    <div class="">
                        <div
                            class="h-full transition duration-300 ease-in-out border-4
                             dark:border-gray-800 border-white dark:bg-gray-800 bg-white
                             rounded-xl shadow-lg overflow-hidden">
                            <img class="lg:h-56 md:h-36 w-full object-cover rounded-lg object-center"
                                 src="/assets/Logos/photo.jpg"
                                 alt="blog">
                            <div class="p-6">
                                <h2 class="tracking-widest text-xs title-font font-medium dark:text-gray-300 text-gray-500 mb-1">
                                    JavaScript</h2>
                                <h1 class="title-font transition duration-300 ease-in-out text-lg font-medium hover:text-blue-500 dark:hover:text-blue-400 dark:text-white text-gray-800 text-white cursor-pointer mb-3">
                                    آموزش جاوااسکریپت</h1>
                                <p class="text-sm text-gray-700 dark:text-gray-300 my-3">
                                    کوئیزهای جاوااسکریپت، می‌خوایم این زبان رو
                                    بهتر یاد بگیریم و با نکته‌های کاربردی بیشتری آشنا بشیم.
                                </p>
