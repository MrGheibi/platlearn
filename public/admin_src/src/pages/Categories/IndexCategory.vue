<template>
  <q-layout view="lHh Lpr lFf">
    <div class=" b-content  bg-white" style="margin-top: 30px !important;">
      <q-card class="b-shadow b-rounded">
        <q-card-section>
        ...
        <q-card-section class="q-pa-none " style="z-index: 0">
          <q-table :data="data" class="shadow-0 b-rounded" :columns="columns" hide-bottom>
